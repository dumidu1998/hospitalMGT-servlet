...
<body class="colBg">
	...
	out.print("selected");%>>
						...
						<div class="col col-lg-6 col-md-10 col-xs-11">
							<div class="row centerCont">
								<div class="col col-lg-3">
									<label for="exampleFormControlInput1" class="form-label">Ward
										Name</label>
								</div>
								<div class="col col-lg-7">
					...
					<div class="row centerCont">
						<div class="col col-lg-6 col-md-10 col-xs-11">
							<div class="row centerCont">
								<div class="col col-lg-3">
									<label for="exampleFormControlInput1" class="form-label">Number
										of beds</label>
								</div>
								<div class="col col-lg-7">
						...
						<div class="col col-lg-6 col-md-10 col-xs-11">
							<div class="row centerCont">
								<div class="col col-lg-3">
									<label for="exampleFormControlInput1" class="form-label">Head
										in charge</label>
								</div>
								<div class="col col-lg-7">
									<select class="form-select" aria-label="Default select example"
										...
										while (rs21.next()) {
										%>
										<option value=<%out.println(rs21.getInt("doctor_id"));%>>
											<%
											out.println(rs21.getString("name"));
											%>
										</option>
										<%
										}
					...
					<div class="row centerCont">
						...
						<div class="col col-lg-6 col-md-10 col-xs-11">
							<div class="row centerCont">
								<div class="col col-lg-3">
									<label for="exampleFormControlInput1" class="form-label">Rates
										(Per-Bed)</label>
								</div>
								<div class="col col-lg-7">
